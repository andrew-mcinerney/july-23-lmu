...
knitr::include_graphics(c("img/sic-algorithm.png"))
``` 
...
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics(c("img/sic-results.png"))
``` 
...
* Start with group penalization and telescope through the $\epsilon$ values until some predefined change point, $\tau$
